...
import com.example.android.android_import_it_application.controllers.fragments.MainScreen
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getFragmentFor(item: MenuItem): Fragment {
        return when (item.itemId){
            R.id.menu_home->MainScreen()
            R.id.menu_coupons->CouponFragment()
            R.id.menu_orders->SeeProductsFragment()
            else -> MainScreen()
        }
    }
